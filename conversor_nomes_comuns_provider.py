...
from .conversor_nomes_comuns_algorithm import ConversorNomesComunsAlgorithm


class ConversorNomesComunsProvider(QgsProcessingProvider):
    ...
    def loadAlgorithms(self):
        ...
        """
        self.addAlgorithm(ConversorNomesComunsAlgorithm())
